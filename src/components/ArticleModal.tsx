        ...
        >
          ...
          <div className="overflow-y-auto flex-1">
            ...
            <div className="px-6 sm:px-12 pb-12 -mt-12 relative">
              ...
              <h2 className="font-tahoma text-3xl sm:text-5xl text-stone-900 mb-8 leading-[1.1]">
                {article.title}
              </h2>
              
              <div className="prose prose-stone prose-lg max-w-none prose-headings:font-tahoma prose-headings:text-stone-900 prose-p:text-stone-700 prose-p:leading-relaxed font-tahoma">
