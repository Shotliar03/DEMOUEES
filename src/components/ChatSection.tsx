...
export default function ChatSection() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-12">
      <div className="bg-white rounded-[32px] shadow-xl border border-stone-200 overflow-hidden flex flex-col h-[500px] md:h-[600px]">
          ...
          <div className="p-4 md:p-6 border-t border-stone-100">
            <AnimatePresence>
              {pdfFile && (
                <motion.div 
                  ...
                  exit={{ opacity: 0, y: 10 }}
                  className="mb-3 flex items-center gap-2 bg-emerald-50 p-2 rounded-xl border border-emerald-100 w-fit"
                >
            ...
            >
              ...
              <button
                ...
                className="p-4 rounded-2xl bg-stone-100 text-stone-600 hover:bg-stone-200 transition-all flex items-center justify-center"
                title="Subir PDF"
              >
                <Upload size={20} />
              </button>
              ...
              <button
                ...
                className="bg-emerald-600 text-white p-4 rounded-2xl hover:bg-emerald-700 disabled:opacity-50 transition-all flex items-center justify-center shadow-lg shadow-emerald-200"
              >
                <Send size={20} />
              </button>
            </form>
